...
public class Add_Books extends AppCompatActivity {
    ...
    Button addBook_selectImageBtn,add_bookBtn;
    ImageView imageIv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_bookBtn=findViewById(R.id.add_bookBtn);
    ...
    void checkValidation(){
        ...
        if(Name.isEmpty()){
            ...
            startAddingBook(Name,Location,Author,Available);
        }
    }

    private void startAddingBook(final String name, final String location, final String author, final String available) {
                ...
                if(uriTask.isSuccessful()){
                    ...
                    ref.child(bId).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            pd.dismiss();
                            Toast.makeText(Add_Books.this, "Book Uploaded", Toast.LENGTH_SHORT).show();

                            //reset view
                            imageIv.setImageURI(null);
                            image_rui=null;

                            startActivity(new Intent(Add_Books.this,AdminDashBorad.class));
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(Add_Books.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                            pd.dismiss();
    ...
    private void showImageDialog() {
        ...
        //dialog box
        AlertDialog.Builder builder=new AlertDialog.Builder(Add_Books.this);
