...
public class Update_Books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update__books);
        //init firebase
        ...
        layoutManager=new LinearLayoutManager(Update_Books.this);
...
//                    book.setbId(ds.getKey());
                ...
                //adapter
                adapterBookImg = new AdapterBooks(Update_Books.this, bookList_search,false,"update");
                recyclerView.setLayoutManager(new LinearLayoutManager(Update_Books.this, LinearLayoutManager.VERTICAL, false));
