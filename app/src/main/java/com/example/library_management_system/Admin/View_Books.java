...
public class View_Books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view__books);
        //init firebase
        ...
        layoutManager=new LinearLayoutManager(View_Books.this);
...
//                    book.setbId(ds.getKey());
                ...
                //adapter
                adapterBookImg = new AdapterBooks(View_Books.this, bookList_search,false,"view");
                recyclerView.setLayoutManager(new LinearLayoutManager(View_Books.this, LinearLayoutManager.VERTICAL, false));
